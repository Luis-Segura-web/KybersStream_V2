...
public final class GetSeriesUseCase_Factory implements Factory<GetSeriesUseCase> {
  ...
  private GetSeriesUseCase_Factory(Provider<XtreamRepository> xtreamRepositoryProvider) {
  ...
  public static GetSeriesUseCase_Factory create(
    ...
    return new GetSeriesUseCase_Factory(xtreamRepositoryProvider);
  }

  public static GetSeriesUseCase newInstance(XtreamRepository xtreamRepository) {
    return new GetSeriesUseCase(xtreamRepository);
  }
}
